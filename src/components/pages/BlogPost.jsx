...
const BlogPost = () => {
  ...
  const seo = {
    title: `${post.title} - Carlson Masonry LLC Blog`,
  ...
  const formatContent = (content) => {
    return content.split('\n').map((paragraph, index) => {
      if (paragraph.startsWith('## ')) {
        return (
          <h2 key={index} className="text-2xl font-bold mt-8 mb-4 text-gray-900" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            {paragraph.replace('## ', '')}
          </h2>
        );
      } else if (paragraph.startsWith('### ')) {
        return (
          <h3 key={index} className="text-xl font-semibold mt-6 mb-3 text-gray-800" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            {paragraph.replace('### ', '')}
          </h3>
        );
      } else if (paragraph.startsWith('• ')) {
      ...
      } else if (paragraph.startsWith(/\d+\. \*\*/)) {
        ...
        if (match) {
          return (
            <div key={index} className="mb-4">
              ...
              <p className="text-gray-700 ml-4">{match[3]}</p>
            </div>
          );
        }
        ...
        <div className="container-custom max-w-4xl">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-8 border-b">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                {post.title}
              </h1>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    {post.author} - Expert masonry professionals serving Northwest Arkansas with over 10 years of experience.
                  </p>
                </div>
